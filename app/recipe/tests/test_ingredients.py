...
class PrivateIngredientsTests(TestCase):
    ...
    def test_filter_ingredients_assigned_to_recipes(self):
        ...
        ingredient1 = Ingredients.objects.create(user=self.user, name='Apples')
        ingredient2 = Ingredients.objects.create(user=self.user, name='Turkey')
        ...
        iS1 = IngredientSerializer(ingredient1)
        iS2 = IngredientSerializer(ingredient2)
        self.assertIn(iS1.data, res.data)
        self.assertNotIn(iS2.data, res.data)
